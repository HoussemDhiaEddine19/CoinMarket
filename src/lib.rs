// src/lib.rs
/*
 * Core library for CoinMarketVault
 */
...
#[derive(Debug)]
pub struct CoinMarketVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoinMarketVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinMarketVault processing");
    
    let mut processor = CoinMarketVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinMarketVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinMarketVaultProcessor::new(false);
